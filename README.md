...
Le is the low-level machine learning library written in C using GObject. Bindings to other languages are provided so Le can be used by C++, Rust and Python programs.
