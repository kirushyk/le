...
{
    le::Tensor x(le::Type::F32, 2, 2, 4,
        1.0, 2.0, 1.0, 2.0,
        2.0, 2.0, 1.0, 1.0
    );

    le::Tensor y(le::Type::F32, 2, 1, 4,
        0.0, 1.0, 1.0, 0.0
    );
    ...
    le::Sequential nn;
    nn << le::DenseLayer("D1", 2, 2);
    nn << le::ActivationLayer("A1", le::Activation::SIGMOID);
    nn << le::DenseLayer("D2", 2, 1);
    nn << le::ActivationLayer("A2", le::Activation::SIGMOID);
