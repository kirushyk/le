...
main (int argc, char *argv[])
{
  ...
  le_sequential_add (neural_network, LE_LAYER (le_activation_layer_new ("Softmax", LE_ACTIVATION_SOFTMAX)));
  ...
  if (filename) {
    ...
    if (loaded_parameters) {
      for (parameters_iterator = parameters, loaded_parameters_iterator = loaded_parameters;
           parameters_iterator && loaded_parameters_iterator; parameters_iterator = parameters_iterator->next,
