...
main ()
{
  ...
  g_assert_true (le_tensor_reshape (train_images, 2, 60000, 28 * 28));
  ...
  g_assert_true (le_tensor_reshape (train_labels, 2, 1, 60000));
  ...
  g_assert_true (le_tensor_reshape (test_images, 2, 10000, 28 * 28));
  ...
  g_assert_true (le_tensor_reshape (test_labels, 2, 1, 10000));
