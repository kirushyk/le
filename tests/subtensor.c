...
main()
{
    ...
    assert(le_matrix_at_u32(transposed_column, 0, 0) == 2);
    assert(le_matrix_at_u32(transposed_column, 0, 1) == 5);
    assert(le_matrix_at_u32(transposed_column, 0, 2) == 8);
    assert(le_tensor_at_u32(transposed_column, 0) == 2);
    assert(le_tensor_at_u32(transposed_column, 1) == 5);
    assert(le_tensor_at_u32(transposed_column, 2) == 8);
    LeTensor *twice_transposed_column = le_matrix_new_transpose(transposed_column);
    assert(le_matrix_at_u32(twice_transposed_column, 0, 0) == 2);
    assert(le_matrix_at_u32(twice_transposed_column, 1, 0) == 5);
    assert(le_matrix_at_u32(twice_transposed_column, 2, 0) == 8);
    assert(le_tensor_at_u32(twice_transposed_column, 0) == 2);
    assert(le_tensor_at_u32(twice_transposed_column, 1) == 5);
    assert(le_tensor_at_u32(twice_transposed_column, 2) == 8);
    assert(le_tensor_equal(twice_transposed_column, middle_column));
    assert(le_tensor_equal(twice_transposed_column, middle_column_copy));
    assert(le_tensor_equal(twice_transposed_column, middle_column_direct_copy));
